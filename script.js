...
class ToDoList extends React.Component {
  ...
  handleSubmit(event) {
    ...
    fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1147", {
      method: "POST",
      mode: "cors",
  ...
  deleteTask(id) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}?api_key=1147`, {
      method: "DELETE",
      mode: "cors",
    }).then(checkStatus)
      .then(json)
      .then((data) => {
        // fetch tasks after delete
        this.fetchTasks();
      })
      .catch((error) => {
        this.setState({ error: error.message });
  ...
  toggleComplete(id, completed) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}/mark_${newState}?api_key=1147`, {
      method: "PUT",
      mode: "cors",
    }).then(checkStatus)
      .then(json)
